...
config.TRAIN.P_CLASS_WEIGHT = 1
config.TRAIN.P_CLASS_AF = 1
config.TRAIN.P_LOC_AF = 1
config.TRAIN.P_OT_WEIGHT = 1
config.TRAIN.EPSILON = 1
...
config.TRAIN.FEAT_TOPK_RATIO = 1
...
if __name__ == '__main__':
    cfg_file = '/data/user5/code/9_a/7_SSAD/experiments/thumos/SSAD.yaml'
